...
export const exportQuotationsFolder = async (quotations, companyOptions = {}, onProgress) => {
  ...
  try {
    ...
    for (let i = 0; i < total; i++) {
      ...
      // Render the actual PrintQuotation React component using React.createElement
      await new Promise((resolve) => {
        root.render(React.createElement(PrintQuotation, { initialData: printData, hideToolbar: true }));
